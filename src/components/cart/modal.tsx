      ...
      <>
         ...
         <Transition show={isOpen}>
            <Dialog onClose={closeCart} className="relative z-50">
               ...
               >
                  <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col bg-gray-300/50 p-6 text-black backdrop-blur-xl md:w-[390px]">
                     ...
                     {!cart || cart.lines.length === 0 ? (
                        <div className="mt-20 flex w-full flex-col items-center justify-center overflow-hidden">
                           ...
                           <p className="mt-6 text-center text-[1.4rem] font-bold">
                              Your Cart is empty.
                           </p>
                        </div>
                     ) : (
                        <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                                 ...
                                 return (
                                    ...
                                    >
                                       <div className="relative flex w-full flex-row justify-between px-1 py-4">
                                          ...
                                          >
                                             <div className="relative h-16 w-16 cursor-pointer overflow-hidden rounded-md border border-neutral-700 bg-neutral-900">
                                                <Image
                           ...
                           <a
                              ...
                              className="block w-full rounded-md bg-black p-3 text-center text-sm font-medium text-white opacity-90 hover:opacity-100"
                           >
                              Proceed to Checkout
                           </a>
                        </div>
